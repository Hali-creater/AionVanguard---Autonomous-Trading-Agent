        ...
        while self.is_running.is_set():
            for symbol in self.config['symbols']:
                ...
                try:
                    ...
                    historical_data, error_message = self.broker.fetch_historical_data(symbol, '1Min', start_date.isoformat(), end_date.isoformat())

                    if error_message:
                        self._send_message("log", error_message)
                        continue
